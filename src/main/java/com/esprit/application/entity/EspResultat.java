...
@Entity
public class EspResultat implements Serializable {
    ...
    @Column(name="LIBEMATIFR", length=23)
    ...
    @Column(name="CODEPERIEXAM", length=2)
    private String codeperiexam;
    @Column(name="NUMEEPRE", length=1)
    private String numeepre;
    @Column(name="LIBETYPEEPREFR", length=18)
    private String libetypeeprefr;
    @Column(name="ID_ET", length=10)
    private String idEt;
    @Column(name="IDENELEV", length=8)
    private String idenelev;
    @Column(name="NOTEEPRE", length=5)
    private String noteepre;
    @Column(name="CODETYPEEPRE", length=2)
