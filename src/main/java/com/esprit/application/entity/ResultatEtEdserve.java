...
@Entity
public class ResultatEtEdserve implements Serializable {
    ...
    @Column(name="MOYEPERIEXAM", length=20)
    private String moyeperiexam;
    @Column(name="RANGPERIEXAM", length=20)
